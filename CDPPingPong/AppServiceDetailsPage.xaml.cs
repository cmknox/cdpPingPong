...
namespace CDPPingPong
{
    ...
    /// </summary>
    public sealed partial class AppServiceDetailsPage : Page
    {
        public AppServiceInfo SelectedAppService { set; get; }
        public AppServiceDetailsPage()
        {
        ...
        private void AppServiceDetailsControl_Loaded(object sender, RoutedEventArgs e) {}
    }
}
